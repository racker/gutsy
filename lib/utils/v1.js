...
exports.get_history_options = function(v1_config, start, end, type){
  var self = this;
  ...
  var path = ['/',
    ...
    exports.scope_maker(v1_config.project), start.toISOString(), end.toISOString())
  ];
  return exports.options(v1_config, path);
};

exports.get_options_from_branch_name = function(v1_config, v1_story_info){
