  ...
  parse_assets: function(asset_classes, cb){
    ...
    _.each(asset_classes, function(assets, asset_type){
      _.each(assets, function(asset_list, scope_sprint){
        ...
        if (bins[scope] === undefined) {
          bins[scope] = {};
        }
        if (bins.Total === undefined) {
          bins.Total = {};
        }
        if (bins[scope][asset_type] === undefined) {
          bins[scope][asset_type] = {};
        }
        if (bins[scope]["Name"] === undefined) {
          bins[scope]["Name"] = "";
        }
        ...
        bins[scope][asset_type] = bins[scope][asset_type] || {};
        ...
        bins[scope]["Name"] = scope_name || "";
        bins.Total["Name"] = "Total";
        ...
        // assets in sprint
        bins[scope][asset_type][sprint_name] = bin;
      });
    });
    cb(null, bins);
  }
