...
module.exports.install = function(app, devops, polling_data, idjson){
  ...
  app.get(
    ...
    function(req, res){
      ...
      db.get_highscores(project, start_date, end_date, null, function(errors, results){
        var place;
        var row;
        var i;
        var in_version_one;
  ...
  app.get(
    ...
    function (req, res) {
      ...
      db.get_highscores(project, start_date, end_date, username, function (errors, results) {
        var context = {};
