...
module.exports.install = function(web_app, installed_projects){
  ...
  add_route('post',
    ...
    function(req, res){
      ...
      var required = ["title", "description", "severity", "scope"];
          ...
          asset = Element("Asset");
            ...
            scope = SubElement(asset, "Relation");
              ...
              scope_asset = SubElement(scope, "Asset");
                ...
                scope_asset.attrib["href"] = "/RACKSPCE/rest-1.v1/Data/Scope/" + data.scope;
          /*
            Severity is READ ONLY - Fix me.
          EG:
            <Error href="/RACKSPCE/rest-1.v1/Data/Defect">
            <Message>Violation'Readonly'Defect.Custom_Severity.Name</Message>
            <Exception class="VersionOne.DataException">
                <Message>Violation'Readonly'Defect.Custom_Severity.Name</Message>
            </Exception>
            </Error>

            severity = SubElement(asset, "Attribute");
              severity.attrib["act"] = "set";
              severity.attrib["name"] = "Custom_Severity.Name";
              ...
              severity_id = SubElement(asset, "Relation");
                severity_id.attrib["href"] = "/RACKSPCE/rest-1.v1/Data/Custom_DefectSeverity/" + severity_number;
                severity_id.attrib["idref"] = severity_number;
          */
