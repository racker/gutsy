      ...
      if (err === true) {
        ...
        // return!
          ...
          <Asset>
            ...
            <Relation name="Scope">
              <Asset href="/RACKSPCE/rest-1.v1/Data/Scope/1038" idref="Scope:1038"/>
            </Relation>
          ...
          asset = Element("Asset");
            ...
            scope = SubElement(asset, "Relation");
              ...
              scope_asset = SubElement(scope, "Asset");
                scope_asset.attrib["act"] = "set";
                scope_asset.attrib["idref"] = "Scope:" + data.project;
                scope_asset.attrib["href"] = "/RACKSPCE/rest-1.v1/Data/Scope/" + data.project;
            priority_name = SubElement(asset, "Attribute");
              priority_name.attrib["name"] = "Custom_Severity.Name";
