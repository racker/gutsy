...
module.exports.install = function(web_app){
  ...
  add_route('get',
    ...
    function(req, res) {
      ...
      var release_notes_poller = project.pollers.release_notes;

      if (true) {
        _.defaults(context, release_notes_poller.get_data());
        return res.render('release_notes.jade', context);
      }
      else {
        worker = new ReleaseNotesWorker(start, end, release_notes_poller);
