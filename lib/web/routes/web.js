...
module.exports.install = function(app, devops){
  app.use(express.errorHandler({ showStack: true, dumpExceptions: true }));

  var default_middleware = [middleware.project_checker(devops), middleware.injector.inject(devops)];
  ...
  app.get(
    ...
    function(req, res) {
      ...
      worker = new ReleaseNotesWorker(devops[req.params.project].pollers, start, end);
  ...
  app.post(
    urls.META_INDEX,
    [express.bodyParser()].concat(default_middleware),
    function(req, res) {
      var data = req.body;
