...
module.exports.install = function(web_app, installed_projects){
  ...
  add_route('post',
    ...
    function(req, res){
      var data = req.body;
      var err = false;
      // data should have data.title .description .severity .project
    /*
      var required = ["title", "description", "severity", "project"];
    ...
    */
      if (err === true) {
        ...
        // return!
          ...
          /*
          Example:
          POST /VersionOne/rest-1.v1/Data/Defect HTTP/1.1
          Content-Type: text/xml; charset=utf-8
          Content-Length: 221

          <Asset>
            <Attribute name="Name" act="set">New Defect</Attribute>
            <Attribute name="Description" act="set">This defect sucks.</Attribute>
            <Relation name="Scope" act="set">
              <Asset idref="Scope:0" />
            </Relation>
            <Relation name="Priority">
              <Asset href="/RACKSPCE/RACKSPCE/rest-1.v1/Data/WorkitemPriority/139" idref="WorkitemPriority:139"/>
            </Relation>
            <Attribute name="Priority.Name">Medium</Attribute>
          </Asset>
          */
        ...
        var post_data = (function(data) {
          ...
          asset = Element("Asset");
            var name = SubElement(asset, "Attribute");
            ...
            scope = SubElement(asset, "Relation");
              ...
              scope_asset = SubElement(scope, "Asset");
                scope_asset.attrib["idref"] = "Scope:" + data.project;
        /*
          priority = SubElement(asset, "Relation");
            priority.attrib["name"] = "Priority";
            priority_asset = SubElement(priority, "Asset");
              priority_asset.attrib["href"] = "/RACKSPCE/RACKSPCE/rest-1.v1/Data/WorkitemPriority/139";
              priority_asset.attrib["idref"] = "WorkitemPriority:139";
        */
          priority_name = SubElement(asset, "Attribute");
            priority_name.attrib["Name"] = "Priority.Name";
            priority_name.text = data.severity;
          return et.tostring(asset);
        }(data));
        ...
        options = {
          ...
          port: 443,
          headers: {
            'Authorization': new Buffer(api_config.auth).toString('base64')
          },
          host: api_config.host, // fix me
        ...
        utils.request_maker(options, function (err, response) {
          ...
          if (err) {
            ...
            v1_response = "Defect Created";
          }
          res.render('defects.jade', {v1_response: v1_response});
        });
      }
  });
