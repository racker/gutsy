...
var Payload = require('./base').Payload;
...
exports.install = function(devops, cb){
  ...
  _.each(projects, function(project){
    ...
    for (name in polling_apis){
      ...
      payload = new Payload(name, poller, api_config);//{error: null, data: null, config: null};

      _install_api(poller, payload);
    }
  });
