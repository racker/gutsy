...
function _get_v1_options(api_config, get_query){
  return {
...
var _sprint_asset_request_maker = function(sprint, type, options_maker){
...
module.exports = function(payload) {
  ...
  var get_v1_options = _.bind(_get_v1_options, null, api_config);
  ...
  function request_assets(sprints, cb){
    ...
    _.each(sprints, function(sprint){
      defect_requests[sprint.id] = _sprint_asset_request_maker(sprint, 'Defect', get_v1_options);
      task_requests[sprint.id] = _sprint_asset_request_maker(sprint, 'Task', get_v1_options);
    });
  ...
  function parse_assets(_assets, cb){
    ...
    _.each(_assets, function(assets, asset_type){
      ...
      _.each(assets, function(asset_list, sprint_id){
        ...
        var _bin_asset = asset_binner_factory(bin, sprint_start_day, sprint_window);
        // assets in sprint
