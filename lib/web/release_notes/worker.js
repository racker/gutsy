...
module.exports = utils.make_class({
  init: function(start, end, release_notes_config){
    var self = this;
    var __worker;

    var dread_data;
    var config = release_notes_config.get_config();
    ...
    if(self.dreadnot_config){
      dread_data = PROJECTS[self.v1_config.project_name].pollers.dreadnot.get_data();
