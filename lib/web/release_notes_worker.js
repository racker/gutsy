...
exports.get_v1_options_from_branch_name = function(v1_config, v1_story_info, selection){
...
module.exports = utils.make_class({
  ...
  _q_v1_request: function(note){
    ...
    var v1_story_info = utils.version_one_match(name);
    if (!v1_story_info){
      return;
    }
    note.set_v1_type(v1_story_info.long_name);

    options = self._v1_options(note.title, v1_story_info, "CreateDate,Description");
