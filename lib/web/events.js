...
var __Event = utils.make_class({
  init: function(version_one_username, github_username, status, related_api, story_points, date, details){
    var self = this;
...
exports.Git_Event = function(user, status, story_points, date, details){
  return new __Event(null, user, status, RELATED_APIS.github, story_points, date, details);
};

exports.V1_Event = function(user, status, story_points, date, details){
  return new __Event(user, null, status, RELATED_APIS.version_one, story_points, date, details);
};
