...
var __EVENT_TYPES = [
  _make_event_type('v1_active', 'created ', 63),
  _make_event_type('v1_closed', 'closed ', 31),
  _make_event_type('v1_other', '??? ', 0),
  _make_event_type('merged', 'merged ', 511),
  _make_event_type('commits_merged', 'contributed to ', 127),
  _make_event_type('reopened', 'was reopened ', -256),
  _make_event_type('opened', 'opened ', 127),
...
exports.V1_Event = function(api_config, v1_asset){
  var create_date = new Date(v1_asset.attributes.CreateDate.text).valueOf();
  var user = v1_asset.attributes['ChangedBy.Name'].text;
  var v1_status = v1_asset.attributes.AssetState.text;
  var event;
  var url;
  var title;
  ...
  title = v1_asset.id;
  url = v1.id_to_url(api_config, v1_asset.id);
