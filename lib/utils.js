...
var V1Asset = exports.make_class({
  init: function(element){
    ...
    self.attributes = element.findall('./Attribute').map(self.make_attribute).reduce(self.reduce('text'), {});
  ...
  make_relation: function(ele){
    ...
    return {
      name: ele.attrib.name,
      asset: assets.map(function(asset){return V1Asset(asset);})
    };
  }
});

// var d = '<Assets total="84" pageSize="2147483647" pageStart="0"><Asset href="/RACKSPCE/rest-1.v1/Data/Timebox/68524" id="Timebox:68524"><Relation name="Schedule.ScheduledScopes"><Asset href="/RACKSPCE/rest-1.v1/Data/Scope/1038" idref="Scope:1038"/><Asset href="/RACKSPCE/rest-1.v1/Data/Scope/31587" idref="Scope:31587"/><Asset href="/RACKSPCE/rest-1.v1/Data/Scope/58440" idref="Scope:58440"/><Asset href="/RACKSPCE/rest-1.v1/Data/Scope/72469" idref="Scope:72469"/><Asset href="/RACKSPCE/rest-1.v1/Data/Scope/90707" idref="Scope:90707"/></Relation><Attribute name="Schedule.ScheduledScopes.Name"><Value>Reach Scrum</Value><Value>Reach R1 (private beta)</Value><Value>Reach R2 (EAP)</Value><Value>Reach R3 (GA)</Value><Value>Reach UG</Value></Attribute></Asset></Assets>';

// exports.parse_v1(d, function(err, results){
  ...
  req = method.request(options, function(res) {
    ...
    res.on('end', function() {
      if (res.statusCode >= 400) {
        var error = "Bad status code: " + res.statusCode;
